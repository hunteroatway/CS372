...
<?php
  ...
  if (isset($_POST["submitted"]) && $_POST["submitted"]) {
    ...
    //will need to add the new fields added
    ...
    if($r1->num_rows == 0) {
      ...
      $q2 = "INSERT INTO Books(isbn_10, isbn_13, title, subtitle, publisher, description,  photo) VALUES ('$isbn10', '$isbn13', '$title', '$subtitle', '$publisher', '$description', '$image')";
      $r2 = $db->query($q2);
